// Sample data for articles and users
...
function renderUserActions() {
  ...
  if (currentUser) {
    $actions.append(
      ...
      <button class="btn btn-outline-secondary btn-sm" id="logout-btn">Logout</button>`
    );
  } else {
    $actions.append(
        ...
        <div class="card h-100">
          ...
          <div class="card-body">
            ...
            <div class="mt-3 d-flex gap-2">
              ...
              <button class="btn btn-${isSaved ? 'success' : 'outline-success'} btn-sm save-article-btn" data-id="${article.id}">${isSaved ? 'Saved' : 'Save'}</button>
  ...
  $(document).on('click', '.view-article-btn', function() {
    ...
    let html = `<h3>${article.title}</h3>
      ...
      <div class="mb-3 d-flex gap-2">
        ...
        <button class="btn btn-outline-info btn-sm share-article-btn" data-id="${id}">Share</button>
        <button class="btn btn-outline-danger btn-sm report-article-btn" data-id="${id}">Report</button>
      </div>
      <hr>
      <h5>Comments</h5>
