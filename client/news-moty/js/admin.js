                                                ...
                                                <td class="py-3">
                                                    <div class="admin-actions-container">
                                                        ${r.ArticleId !== null ? `
                                                            ...
                                                            <button class="admin-action-btn admin-delete-article-btn delete-article-btn"
                                                        ...
                                                        <button class="admin-action-btn admin-delete-report-btn delete-report-btn"
                                                                data-report-id="${r.Id}"
                                                                data-article-id="${r.ArticleId}" 
...
$(document).on('click', '.toggle-deactivate-btn', async function () {
    ...
    try {
        ...
        showErrorToast("Failed to toggle user status. Please try again.", "Admin Action Failed");
...
$(document).on('click', '.toggle-block-btn', async function () {
    ...
    try {
        ...
        showErrorToast("Failed to toggle sharing permission. Please try again.", "Admin Action Failed");
        $btn.html(originalHtml).prop('disabled', false);
    }
});
